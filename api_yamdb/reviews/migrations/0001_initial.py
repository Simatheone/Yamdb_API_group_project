<<<<<<< HEAD
# Generated by Django 2.2.16 on 2022-03-03 17:49
=======
# Generated by Django 2.2.16 on 2022-03-03 18:45
>>>>>>> feature/titles-api
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с таким именем уже зарегистрирован'}, help_text='Представьтесь пожалуйста.', max_length=257, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='Пользователь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='categories', to='reviews.Category', verbose_name='Категория произведения')),
