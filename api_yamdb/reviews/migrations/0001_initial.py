    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "first_name",
                    models.CharField(blank=True, max_length=257, verbose_name="Имя"),
                ),
                (
                    "last_name",
                    models.CharField(
                        blank=True, max_length=257, verbose_name="Фамилия"
                    ),
                ),
                (
                    "email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(
                        help_text="Введите текст обзора", verbose_name="Текст"
                    ),
                ),
                (
                    "score",
                    models.PositiveIntegerField(
                        help_text="Оцените произведение", verbose_name="Оценка"
                    ),
                ),
                (
                    "pub_date",
                    models.DateTimeField(auto_now_add=True, verbose_name="Дата обзора"),
                ),
                (
                    "author",
                    models.ForeignKey(
